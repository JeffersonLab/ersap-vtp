...
import org.jlab.epsci.stream.sampaBB.SMPTwoStreamEngineAggregator;
import org.jlab.epsci.stream.sampaBB.SampaType;
 ...
 * @author timmer
 */
public class SampaSourceEngine extends AbstractEventReaderService<SMPTwoStreamEngineAggregator> {
    ...
    @Override
    protected SMPTwoStreamEngineAggregator createReader(Path file, JSONObject opts)
        ...
        try {
            SMPTwoStreamEngineAggregator v =
                    new SMPTwoStreamEngineAggregator(port1, port2,
                                            1, 2,
                                      0, SampaType.DAS);
