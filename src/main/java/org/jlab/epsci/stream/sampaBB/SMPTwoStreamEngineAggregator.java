...
public class SMPTwoStreamEngineAggregator {
    ...
    private final SReceiver receiver1;
    /** Data receiver reading from second data stream. */
    private final SReceiver receiver2;
    /** Data aggregator reading from both receivers. */
    private final SAggregator aggregator12;
     ...
     */
    public SMPTwoStreamEngineAggregator(int sampaPort1, int sampaPort2,
...
//        }
    ...
    public ByteBuffer getSerializedData() throws InterruptedException {
        ...
        ByteBuffer bb = null;
        try {
            bb = SampaDasType.serialize(item.getData());
