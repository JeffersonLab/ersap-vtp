            ...
            switch (orientation) {
                case "center":
                    if (b.size() == 1
                        ...
                        hb.fill(center.get(0));
                        hc.fill(center.get(0));
                        he.fill(center.get(0));
                    }
                    break;
                case "left":
                    if (a.size() == 1
                        ...
                        ha.fill(center.get(0));
                        hl.fill(center.get(0));
                        hd.fill(center.get(0));
                    }
                    break;
                case "right":
                    if (cc.size() == 1
                        ...
                        hcc.fill(center.get(0));
                        hr.fill(center.get(0));
                        hf.fill(center.get(0));
                    }
                    break;
            }
        }
